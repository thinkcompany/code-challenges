...
* *Standards*: Your solution should be valid, semantic, accessible, and performant. To get an idea of what how we're doing things, please feel free to review our [development standards](https://bitbucket.org/thinkcompany/tbi_dev-standards/src).
...
## Resources
* [Think Company Development Standards](https://bitbucket.org/thinkcompany/tbi_dev-standards/src)
